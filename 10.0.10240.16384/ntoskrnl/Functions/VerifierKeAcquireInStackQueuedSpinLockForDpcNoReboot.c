...
int __fastcall VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot(unsigned int a1, unsigned int a2)
{
  int v4; // r3
  unsigned int v5; // r2
  ...
  return pXdvKeAcquireInStackQueuedSpinLockForDpc(a1, a2);
}
