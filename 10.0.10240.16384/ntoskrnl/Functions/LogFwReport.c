...
void __fastcall LogFwReport(int a1, int a2, int a3)
{
  ...
  if ( (dword_619018 & 0x80) != 0 )
  {
    ...
    BgpFwQueryPerformanceCounter(v6, (int)&qword_617930, a3, dword_619018);
    BgpGetResolution(v6);
    dword_641950 = v6[0];
    dword_641954 = v6[1];
    unk_641958 = v6[2];
    dword_641984 = BgpGetBitsPerPixel();
    *(_QWORD *)&v3 = *(_QWORD *)&qword_617930;
    dword_641980 = dword_619018;
    if ( !*(_QWORD *)&qword_617930 )
      __brkdiv0();
    dword_641964 = _rt_sdiv64(*(__int64 *)&qword_617930, 1000000 * qword_641978);
    if ( !v3 && !v4 )
      __brkdiv0();
