...
int __fastcall CmDeleteDeviceContainerRegKey(int a1, int a2, int a3)
{
  ...
  v8 = CmDeleteDeviceContainerRegKeyWorker(a1, a2, a3);
  if ( !v6 )
    return v8;
  v11 = v8;
  v9 = v6(a1, a2, 5, 12, 2, &v11);
  if ( v9 == -1073741822 )
    return v8;
  if ( v9 == -1073741536 )
    return v11;
