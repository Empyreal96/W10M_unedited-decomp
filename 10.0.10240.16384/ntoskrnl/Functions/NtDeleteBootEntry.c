...
int __fastcall NtDeleteBootEntry(unsigned int a1)
{
  int v2; // r4
  unsigned int v3; // r3
  unsigned int v4; // r2
  ...
  if ( v7 )
    *(_BYTE *)(v7 + 14) |= 1u;
  dword_61A084 = v5;
  swprintf_s((int)v15, 9, (int)L"Boot%04X", a1);
  v14[0] = 0;
  v2 = IoGetEnvironmentVariableEx((int)v15, (int)EfiBootVariablesGuid, 0, (int)v14, 0);
  if ( v2 != -1073741568 )
    goto LABEL_17;
...
LABEL_17:
    if ( !v2 || v2 == -1073741789 )
      v2 = IoSetEnvironmentVariableEx((int)v15, (int)EfiBootVariablesGuid, 0, 0, 1);
  }
  dword_61A084 = 0;
  __dmb(0xBu);
  do
