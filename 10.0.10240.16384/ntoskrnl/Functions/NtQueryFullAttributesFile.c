...
int __fastcall NtQueryFullAttributesFile(int a1, unsigned int a2)
{
  ...
  int v11[3]; // [sp+14h] [bp-174h] BYREF
  int v12[28]; // [sp+20h] [bp-168h] BYREF
  _BYTE v13[56]; // [sp+90h] [bp-F8h] BYREF
