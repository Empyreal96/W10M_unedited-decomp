...
int __fastcall CmpLockHashEntryExclusiveByKcb(int a1)
{
  int v2; // r5
  unsigned int v3; // r8
  int v4; // r0
  ...
  v3 = *(_DWORD *)(v2 + 1844)
     + 12
     * ((*(_DWORD *)(v2 + 1848) - 1) & ((101027 * (*(_DWORD *)(a1 + 12) ^ (*(_DWORD *)(a1 + 12) >> 9))) ^ ((unsigned int)(101027 * (*(_DWORD *)(a1 + 12) ^ (*(_DWORD *)(a1 + 12) >> 9))) >> 9)));
