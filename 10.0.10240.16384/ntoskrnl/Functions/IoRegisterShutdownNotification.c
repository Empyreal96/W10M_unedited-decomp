...
int __fastcall IoRegisterShutdownNotification(int a1)
{
  int *v2; // r5
  __int64 v3; // kr00_8
  int v4; // r3
  ...
  IopInterlockedInsertHeadList(&IopNotifyShutdownQueueHead, v2);
  *(_DWORD *)(a1 + 28) |= 0x800u;
  v12 = 0;
  ...
  if ( EtwApiCallsProvRegHandle )
  {
    ...
    *((_QWORD *)v9 + 1) = 4i64;
    EtwWrite(v3, SHIDWORD(v3), (int)KERNEL_AUDIT_API_IOREGISTERSHUTDOWNNOTIFICATION, 0);
  }
  return 0;
}
