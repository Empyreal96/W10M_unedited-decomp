...
int __fastcall VerifierKeAcquireInStackQueuedSpinLockAtDpcLevel(int a1, unsigned int a2)
{
  unsigned int v3; // r5
  int v4; // r3
  unsigned int v5; // r2
  ...
  pXdvKeAcquireInStackQueuedSpinLockAtDpcLevel(v3, a2);
  return VfDeadlockAcquireResource(v3, 6, __mrc(15, 0, 13, 0, 3) & 0xFFFFFFC0, 0);
}
