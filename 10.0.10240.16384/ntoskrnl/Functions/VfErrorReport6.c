...
int __fastcall VfErrorReport6(int a1, int a2, int a3, int a4)
{
  unsigned int v8; // r0
  int v9; // r1
  int v10; // r2
  ...
  unsigned int v12; // r4
  int result; // r0
  _DWORD v14[6]; // [sp+8h] [bp-78h] BYREF
  char v15[96]; // [sp+20h] [bp-60h] BYREF
  ...
  else
  {
    ...
    if ( RtlStringCbPrintfA((int)v15, 0x47u, (int)"CulpritAddress = %p, Irp = %p, Status = 0x%x.\n", a2) >= 0 )
