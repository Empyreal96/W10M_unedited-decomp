...
int __fastcall RtlOemStringToUnicodeString(unsigned __int16 *a1, unsigned __int8 **a2, int a3, int a4)
{
  unsigned int v7; // r0
  unsigned int v8; // r3
  int v9; // r3
  ...
  unsigned __int8 **varg_r1; // [sp+2Ch] [bp+Ch]
...
LABEL_18:
  ...
  *a1 = v9;
  ...
  v13 = RtlOemToUnicodeN(*((char **)a1 + 1), *a1, v14, a2[1], *(unsigned __int16 *)a2);
  if ( v13 >= 0 )
  {
