...
int __fastcall PsGetSiloObjectFromJob(int a1, int a2, _DWORD *a3, int a4)
{
  char v6; // r3
  int v7; // r2
  int v8; // r4
  ...
  v8 = ObReferenceObjectByHandle(a1, 4, PsJobType, v6, (int)v12, 0);
  if ( v8 >= 0 )
  {
    ...
    if ( v10 )
    {
      v8 = PsGetSiloObjectByPointer(v10, a2, a3);
