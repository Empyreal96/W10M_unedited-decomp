...
_DWORD *__fastcall CcReferenceFileOffset(_DWORD *result, int a2, unsigned int a3, int a4)
{
  _DWORD *v4; // r7
  ...
  int v17; // r4
  unsigned int v18; // r1
  int var28[14]; // [sp+8h] [bp-28h] BYREF
  ...
  varg_r3 = a4;
  v4 = result;
  if ( *((__int64 *)result + 3) > 0x2000000 )
  {
    var28[1] = (int)var28;
    var28[0] = (int)var28;
    var28[2] = 0;
    var28[3] = 0;
    if ( !CcAllocateVacbLevels(CcMaxVacbLevelsSeen - 1, (result[24] & 0x200) != 0, var28) )
      RtlRaiseStatus(-1073741670);
    v5 = (unsigned __int8 *)(v4 + 45);
    v6 = KeAbPreAcquire((unsigned int)(v4 + 45), 0, 0);
    v7 = KfRaiseIrql(1);
    do
      v8 = __ldrex(v5);
    ...
    if ( v12 )
      *(_BYTE *)(v12 + 14) |= 1u;
    SetVacb((int)v4, v11, varg_r2, varg_r3, 0xFFFFFFFF);
    __pld(v9);
    v14 = *(_DWORD *)v9;
    v15 = *(_DWORD *)v9 - 16;
...
LABEL_23:
    ...
    KeAbPostRelease((unsigned int)(v4 + 45));
    result = CcFreeUnusedVacbLevels(var28);
  }
  return result;
}
