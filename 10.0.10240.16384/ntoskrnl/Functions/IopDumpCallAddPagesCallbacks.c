...
int __fastcall IopDumpCallAddPagesCallbacks(int result, int a2)
{
  int v2; // r4
  int v3; // r5
  int v4; // r6
  ...
  while ( 1 )
  {
    ...
    if ( (int *)v3 == &KeBugCheckAddRemovePagesCallbackListHead )
      break;
    v9[2] = v3;
    result = KeValidateBugCheckCallbackRecord(v3, 4, v9);
    if ( result )
    {
      v10 = 0;
      v12 = v2;
      ...
      do
      {
        ...
        v5 = 0;
        v7[0] = 0;
        result = (*(int (__fastcall **)(int, int, int *, int))(v3 + 8))(4, v3, &v10, 20);
        v2 = v8;
        if ( v4 >= 0 && v14 )
        {
          result = IopAddPageDumpRange(&v10, v7);
          v4 = result;
