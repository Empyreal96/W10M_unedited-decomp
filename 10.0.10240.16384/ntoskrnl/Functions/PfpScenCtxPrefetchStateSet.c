...
int __fastcall PfpScenCtxPrefetchStateSet(unsigned int a1, int a2, int a3, int a4)
{
  unsigned int v8; // r5
  int v9; // r0
  int v10; // r7
  ...
  if ( *(_DWORD *)(a1 + 28) == a2 )
  {
    if ( a3 == 1 && (*(_DWORD *)(a1 + 4) & 0xC) == 8 )
    {
      v12 = -1073741431;
    }
    else
    {
      if ( (*(_DWORD *)(a1 + 4) & 0xC) == 4 )
      {
        KeSetEvent(a1 + 8, 1, 0);
        *(_DWORD *)(a1 + 4) &= 0xFFFFFFF3;
      }
      v12 = 0;
      *(_DWORD *)(a1 + 4) = *(_DWORD *)(a1 + 4) & 0xFFFFFFFC | a3 & 3;
    }
  }
  else
  {
