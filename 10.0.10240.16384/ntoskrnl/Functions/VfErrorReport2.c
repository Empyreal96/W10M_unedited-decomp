...
int __fastcall VfErrorReport2(int a1, int a2, _DWORD *a3, int a4)
{
  unsigned int v8; // r0
  int v9; // r1
  int v10; // r2
  ...
  int result; // r0
  int v14; // r4
  _DWORD v15[6]; // [sp+8h] [bp-80h] BYREF
  char v16[104]; // [sp+20h] [bp-68h] BYREF
  ...
  else
  {
    ...
    if ( RtlStringCbPrintfA((int)v16, 0x4Bu, (int)"CulpritAddress = %p, Irp = %p, DeviceObject = %p.\n", a2) >= 0 )
