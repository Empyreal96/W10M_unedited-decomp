...
unsigned int __fastcall MiPopFreeWsle(int a1)
{
  ...
  if ( (v6 & 1) != 0 || (*(_DWORD *)(v4 * result + v5) & 0xFFE) != 4094 )
    KeBugCheckEx(26, 20481, (int)v1, result, *(_DWORD *)(v4 * result + v5));
  v7 = v6 >> 12;
  if ( v6 >> 12 != 0xFFFFF )
  {
    if ( v7 > v3 )
      KeBugCheckEx(26, 20482, (int)v1, result, *(_DWORD *)(v4 * result + v5));
    v8 = *(_DWORD *)(v4 * v7 + v5);
    if ( (v8 & 1) != 0 || (((unsigned __int16)result ^ (unsigned __int16)(v8 >> 1)) & 0x7FF) != 0 )
      KeBugCheckEx(26, 20483, (int)v1, result, *(_DWORD *)(v4 * v7 + v5));
