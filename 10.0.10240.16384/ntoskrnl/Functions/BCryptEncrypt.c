...
int __fastcall BCryptEncrypt(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  int v9; // r5
  int v13; // r7
  unsigned int *v14; // r0
  ...
  if ( v13 )
  {
    v9 = (*(int (__fastcall **)(int, int, int, int, _DWORD, _DWORD, int, int, int, _DWORD))(v13 + 44))(
           a1,
           a2,
           a3,
           a4,
