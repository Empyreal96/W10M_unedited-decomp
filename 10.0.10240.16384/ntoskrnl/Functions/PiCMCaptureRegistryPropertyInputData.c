...
int __fastcall PiCMCaptureRegistryPropertyInputData(unsigned int a1, unsigned int a2, int a3, int a4)
{
  int v4; // r4
  int v5; // lr
  int v6; // r10
  ...
  if ( a2 < 0x28 || (memmove(a4, a1, 0x28u), v5 = 0, *(_DWORD *)v4 != 40) )
    v7 = -1073741811;
  if ( v7 >= 0 )
  {
    v8 = *(_DWORD *)(v4 + 12);
...
LABEL_22:
        ...
        *(_DWORD *)(v4 + 28) = 0;
        if ( v10 )
        {
          ...
          if ( v11 )
          {
            v7 = PiControlMakeUserModeCallersCopy((int *)(v4 + 28), v10, v11, 1, v6, 1);
            v5 = v15;
            if ( v7 < 0 )
            {
              *(_DWORD *)(v4 + 28) = 0;
