...
int __fastcall PnpDisableDeviceInterfaces(unsigned __int16 *a1)
{
  ...
  __int16 v16[20]; // [sp+20h] [bp-28h] BYREF
  ...
  *(_WORD *)(v3 + 308) = v4;
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( v7 < 5 )
    {
      ...
      v5 = CmGetMatchingFilteredDeviceInterfaceList(PiPnpRtlCtx, 0, v15, 1, 0, 0, (int)v2, v14, (int)&v14, 0);
      ++v7;
      if ( v5 != -1073741789 )
        break;
      v6 = v14;
    ...
    if ( v5 >= 0 )
    {
      ...
      while ( v9 )
      {
        ...
        if ( v5 >= 0 )
          IoSetDeviceInterfaceState((int)v16, 0);
        v10 += ((unsigned int)(unsigned __int16)v16[0] + 2) >> 1;
        v9 = *v10;
      }
    }
  }
