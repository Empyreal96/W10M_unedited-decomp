...
int __fastcall RtlUpcaseUnicodeStringToAnsiString(unsigned __int16 *a1, unsigned __int16 **a2, int a3, int a4)
{
  unsigned int v7; // r0
  unsigned int v8; // r3
  int v9; // r0
...
LABEL_6:
  ...
  *a1 = v7 - 1;
  ...
  v12 = RtlUpcaseUnicodeToMultiByteN(*((_BYTE **)a1 + 1), *a1, v13, a2[1], *(unsigned __int16 *)a2);
  if ( v12 >= 0 )
  {
