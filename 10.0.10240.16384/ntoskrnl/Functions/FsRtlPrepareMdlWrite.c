...
int __fastcall FsRtlPrepareMdlWrite(_DWORD *a1, int a2, int a3, int a4, int a5, int a6)
{
  int v10; // r0
  _DWORD *v11; // r5
  ...
  if ( v11 && *v11 > 0x48u && (v12 = (int (__fastcall *)(_DWORD *, int, int, int, int, int, int, int))v11[18]) != 0 )
