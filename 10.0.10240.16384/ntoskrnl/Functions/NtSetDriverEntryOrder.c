...
int __fastcall NtSetDriverEntryOrder(unsigned int a1, unsigned int a2)
{
  unsigned int v2; // r6
  unsigned int v4; // r5
  int v5; // r4
  ...
  if ( v15 )
    *(_BYTE *)(v15 + 14) |= 1u;
  dword_61A084 = v13;
  v5 = IoSetEnvironmentVariableEx((int)L"DriverOrder", (int)EfiDriverVariablesGuid, v4, 2 * v2, 1);
  dword_61A084 = 0;
  __dmb(0xBu);
  do
