...
int __fastcall PiControlQueryAndRemoveDevice(int a1, int *a2, int a3, char a4)
{
  unsigned int v5; // r2
  int v6; // r7
  int v7; // r1
...
LABEL_15:
    ...
    if ( v11 >= 0 )
    {
      v11 = PnpQueueQueryAndRemoveEvent((int)v15, a2 + 3, v9, &v14, a2[2], 0);
      if ( v9 )
      {
        v12 = PiControlMakeUserModeCallersCopy(a2 + 4, (int)v9, 2 * a2[5], 2, v6, 0);
        if ( v12 < 0 )
          v11 = v12;
      }
      a2[5] = v14 >> 1;
